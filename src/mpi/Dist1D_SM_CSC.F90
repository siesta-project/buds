...
!> @defgroup dist-1d-sm-csc Parallel distribution (1D) with associated sparse matrix
...
# define BUD_MOD_NAME BUD_CC3(BUD_MOD,_,iDist1D_CSC)
...
# define BUD_TYPE_NAME BUD_CC2(BUD_TYPE,iD1D_CSC)
# define BUD_TYPE_NEW BUD_CC3(BUD_NEW,_,Dist_CSC)
# define BUD_COLL_1 BUD_CC2(BUD_TYPE,iDist1D)
# define BUD_COLL_2 BUD_CC2(BUD_TYPE,iSM_CSC)
...
!!$# define BUD_MOD_NAME BUD_CC3(BUD_MOD,_,lDist1D_CSC)
...
!!$# define BUD_TYPE_NAME BUD_CC2(BUD_TYPE,lD1D_CSC)
!!$# define BUD_TYPE_NEW BUD_CC3(BUD_NEW,_,Dist_CSC)
!!$# define BUD_COLL_1 BUD_CC2(BUD_TYPE,lDist1D)
!!$# define BUD_COLL_2 BUD_CC2(BUD_TYPE,lSM_CSC)
!!$# define BUD_TYPE_VAR integer
!!$# define BUD_PREC il_
...
!> @defgroup Distribution+sparse matrix module for all precision objects of CSC matrix
!! @ingroup dist-1d-sm
!! Module for making everything public
!! @{
module BUD_CC3(BUD_MOD,_,Dist1D_CSC)

  use BUD_CC3(BUD_MOD,_,iDist1D_CSC)
!!$  use BUD_CC3(BUD_MOD,_,lDist1D_CSC)

end module
!> @}

! GROUP dist-1d-sm-csc
!> @}
