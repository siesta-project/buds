...
!> @defgroup dist1d-sm-csr0-array CSR0 format
!! @ingroup sm-array
!! @ingroup sm-csr0
!!
!! @{
...
#if BUD_DIM == 1
!> @defgroup dist1d-sm-csr0-array-BUD_DIM Sparse matrix
#elif BUD_DIM == 2
!> @defgroup dist1d-sm-csr0-array-BUD_DIM Sparse matrix, 1 extra dimension per element
#elif BUD_DIM == 3
!> @defgroup dist1d-sm-csr0-array-BUD_DIM Sparse matrix, 2 extra dimensions per element
#elif BUD_DIM == 4
!> @defgroup dist1d-sm-csr0-array-BUD_DIM Sparse matrix, 3 extra dimensions per element
#elif BUD_DIM == 5
!> @defgroup dist1d-sm-csr0-array-BUD_DIM Sparse matrix, 4 extra dimensions per element
#endif
!! @ingroup dist1d-sm-csr0-BUD_DIM
!!
...
# define BUD_MOD_1_2 BUD_CC2(BUD_MOD,_iDist1D_CSR0)
# define BUD_TYPE_1_2 BUD_CC2(BUD_TYPE,iD1D_CSR0)
...
# define BUD_MOD_NAME BUD_CC3(BUD_MOD,_,iDist1D_CSR0_b1D)
...
# define BUD_TYPE_NAME BUD_CC2(BUD_TYPE,iD1D_CSR0_b1D)
...
# define BUD_MOD_2_3 BUD_CC2(BUD_MOD,_iCSR0_b1D)
# define BUD_TYPE_2_3 BUD_CC2(BUD_TYPE,iCSR0_b1D)
#include "Dist1D_SM_Array.inc"
end module
!> @}

# define BUD_MOD_NAME BUD_CC3(BUD_MOD,_,iDist1D_CSR0_r1D)
...
# define BUD_TYPE_NAME BUD_CC2(BUD_TYPE,iD1D_CSR0_r1D)
# define BUD_TYPE_VAR real
# define BUD_TYPE_VAR_PREC rr_
# define BUD_COLL_1 BUD_CC2(BUD_TYPE,iDist1D)
# define BUD_COLL_2 BUD_CC2(BUD_TYPE,iSM_CSR0)
# define BUD_COLL_3 BUD_CC2(BUD_TYPE,rArray1D)
# define BUD_MOD_2_3 BUD_CC2(BUD_MOD,_iCSR0_r1D)
# define BUD_TYPE_2_3 BUD_CC2(BUD_TYPE,iCSR0_r1D)
#include "Dist1D_SM_Array.inc"
end module
!> @}

# define BUD_MOD_NAME BUD_CC3(BUD_MOD,_,iDist1D_CSR0_d1D)
...
# define BUD_TYPE_NAME BUD_CC2(BUD_TYPE,iD1D_CSR0_d1D)
# define BUD_TYPE_VAR real
# define BUD_TYPE_VAR_PREC rd_
# define BUD_COLL_1 BUD_CC2(BUD_TYPE,iDist1D)
# define BUD_COLL_2 BUD_CC2(BUD_TYPE,iSM_CSR0)
# define BUD_COLL_3 BUD_CC2(BUD_TYPE,dArray1D)
# define BUD_MOD_2_3 BUD_CC2(BUD_MOD,_iCSR0_d1D)
# define BUD_TYPE_2_3 BUD_CC2(BUD_TYPE,iCSR0_d1D)
#include "Dist1D_SM_Array.inc"
end module
!> @}

# define BUD_MOD_NAME BUD_CC3(BUD_MOD,_,iDist1D_CSR0_c1D)
...
# define BUD_TYPE_NAME BUD_CC2(BUD_TYPE,iD1D_CSR0_c1D)
# define BUD_TYPE_VAR complex
# define BUD_TYPE_VAR_PREC rr_
# define BUD_COLL_1 BUD_CC2(BUD_TYPE,iDist1D)
# define BUD_COLL_2 BUD_CC2(BUD_TYPE,iSM_CSR0)
# define BUD_COLL_3 BUD_CC2(BUD_TYPE,cArray1D)
# define BUD_MOD_2_3 BUD_CC2(BUD_MOD,_iCSR0_c1D)
# define BUD_TYPE_2_3 BUD_CC2(BUD_TYPE,iCSR0_c1D)
#include "Dist1D_SM_Array.inc"
end module
!> @}

# define BUD_MOD_NAME BUD_CC3(BUD_MOD,_,iDist1D_CSR0_z1D)
...
# define BUD_TYPE_NAME BUD_CC2(BUD_TYPE,iD1D_CSR0_z1D)
# define BUD_TYPE_VAR complex
# define BUD_TYPE_VAR_PREC rd_
# define BUD_COLL_1 BUD_CC2(BUD_TYPE,iDist1D)
# define BUD_COLL_2 BUD_CC2(BUD_TYPE,iSM_CSR0)
# define BUD_COLL_3 BUD_CC2(BUD_TYPE,zArray1D)
# define BUD_MOD_2_3 BUD_CC2(BUD_MOD,_iCSR0_z1D)
# define BUD_TYPE_2_3 BUD_CC2(BUD_TYPE,iCSR0_z1D)
#include "Dist1D_SM_Array.inc"
end module
!> @}


! GROUP dist1d-sm-csr0-array-BUD_DIM
!> @}

! GROUP dist1d-sm-csr0-array
!> @}
