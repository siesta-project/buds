...
!> @defgroup sm-csc-array CSC format
!! @ingroup sm-array
!! @ingroup sm-csc
!!
!! @{
...
#if BUD_DIM == 1
!> @defgroup sm-csc-array-BUD_DIM Sparse matrix
#elif BUD_DIM == 2
!> @defgroup sm-csc-array-BUD_DIM Sparse matrix, 1 extra dimension per element
#elif BUD_DIM == 3
!> @defgroup sm-csc-array-BUD_DIM Sparse matrix, 2 extra dimensions per element
#elif BUD_DIM == 4
!> @defgroup sm-csc-array-BUD_DIM Sparse matrix, 3 extra dimensions per element
#elif BUD_DIM == 5
!> @defgroup sm-csc-array-BUD_DIM Sparse matrix, 4 extra dimensions per element
#endif
!! @ingroup sm-csc-BUD_DIM
!!
...
# define BUD_MOD_NAME BUD_CC3(BUD_MOD,_,iCSC_b1D)
...
# define BUD_TYPE_NAME BUD_CC2(BUD_TYPE,iCSC_b1D)
# define BUD_TYPE_NEW BUD_CC3(BUD_NEW,_,CSC_1D)
# define BUD_TYPE_VAR logical
#undef BUD_TYPE_VAR_PREC
# define BUD_COLL_1 BUD_CC2(BUD_TYPE,iSM_CSC)
# define BUD_COLL_2 BUD_CC2(BUD_TYPE,bArray1D)
#include "SM_Array.inc"
end module
!> @}

# define BUD_MOD_NAME BUD_CC3(BUD_MOD,_,iCSC_r1D)
...
#include "bud_common_declarations.inc"
# define BUD_TYPE_NAME BUD_CC2(BUD_TYPE,iCSC_r1D)
# define BUD_TYPE_NEW BUD_CC3(BUD_NEW,_,CSC_1D)
...
# define BUD_MOD_NAME BUD_CC3(BUD_MOD,_,iCSC_d1D)
...
#include "bud_common_declarations.inc"
# define BUD_TYPE_NAME BUD_CC2(BUD_TYPE,iCSC_d1D)
# define BUD_TYPE_NEW BUD_CC3(BUD_NEW,_,CSC_1D)
# define BUD_TYPE_VAR real
...
# define BUD_MOD_NAME BUD_CC3(BUD_MOD,_,iCSC_c1D)
...
#include "bud_common_declarations.inc"
# define BUD_TYPE_NAME BUD_CC2(BUD_TYPE,iCSC_c1D)
# define BUD_TYPE_NEW BUD_CC3(BUD_NEW,_,CSC_1D)
...
# define BUD_MOD_NAME BUD_CC3(BUD_MOD,_,iCSC_z1D)
...
#include "bud_common_declarations.inc"
# define BUD_TYPE_NAME BUD_CC2(BUD_TYPE,iCSC_z1D)
# define BUD_TYPE_NEW BUD_CC3(BUD_NEW,_,CSC_1D)
# define BUD_TYPE_VAR complex
# define BUD_TYPE_VAR_PREC rd_
# define BUD_COLL_1 BUD_CC2(BUD_TYPE,iSM_CSC)
...
# define BUD_MOD_NAME BUD_CC3(BUD_MOD,_,CSC_1D)
!> @defgroup BUD_MOD_NAME for all data-precision CSC sparse matrices
!! @{
module BUD_MOD_NAME
  use BUD_CC3(BUD_MOD,_,iCSC_b1D)
  use BUD_CC3(BUD_MOD,_,iCSC_r1D)
  use BUD_CC3(BUD_MOD,_,iCSC_d1D)
  use BUD_CC3(BUD_MOD,_,iCSC_c1D)
  use BUD_CC3(BUD_MOD,_,iCSC_z1D)
end module
!> @}


! GROUP sp-csc-array-BUD_DIM
!> @}
