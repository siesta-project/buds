...
# define BUD_TYPE_NEW BUD_CC3(BUD_NEW,_,bSM1DiCSR)
...
# define BUD_TYPE_NEW BUD_CC3(BUD_NEW,_,rSM1DiCSR)
...
# define BUD_TYPE_NEW BUD_CC3(BUD_NEW,_,dSM1DiCSR)
# define BUD_TYPE_VAR real
...
# define BUD_TYPE_NEW BUD_CC3(BUD_NEW,_,cSM1DiCSR)
...
# define BUD_TYPE_NEW BUD_CC3(BUD_NEW,_,zSM1DiCSR)
# define BUD_TYPE_VAR complex
# define BUD_TYPE_VAR_PREC rd_
# define BUD_COLL_1 BUD_CC2(BUD_TYPE,iSM_CSR)
